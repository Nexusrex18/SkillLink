...
export default function ProfessionalWorkerProfile() {
  ...
  const goToJobHistory = () => {
    navigate("/job-history"); // Navigate to the job history page
  };
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-1/3 space-y-6">
            ...
            <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
              ...
              {/* View All Jobs Button - Added below current jobs */}
              <div className="mt-4">
                <button
                  onClick={goToJobHistory}
                  className="w-full py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors flex items-center justify-center gap-2"
                >
